...
- **Ngoại lệ**: typo / đổi UI text thuần / config-only nhỏ (không đụng business logic) → được sửa trực tiếp, nhưng **vẫn phải verify lại** sau khi sửa. Nghi ngờ ảnh hưởng logic → quay lại Tester-before-Dev đầy đủ.
